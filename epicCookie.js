	...
	functionUpdates: {
		...
		updates: [
			...
			},
			{
				...
				description: 'Wont let you ascend if you havent used the Sugar Frenzy yet',
				hash: -2114144281,
				newFunction: bypass =>
				{
							...
							if (me.selected && onWrinkler==0 && Game.CanClick)
							{
								...
								if (Game.Click && Game.lastClickedEl==l('backgroundLeftCanvas'))
								{
									...
									else
									{
										...
										if (me.hp > 0.5) Game.Notify(choose(wrinklerComplaints),'<b>HP: '+Beautify(me.hp, 2)+'</b>',[19,8],6);
